...
select * from books where email_of_author = "m.dorofee@mail.com";
select * from books where isbn = "9786171271159";
select * from books where category = "Романы о любви";
select * from books where count_of_pages > 200 and age_of_author > 35;
select * from books where category = "Приключенческие" or category = "Классика";
